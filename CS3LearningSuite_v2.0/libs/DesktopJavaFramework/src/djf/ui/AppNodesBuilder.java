...
//    }
    ...
    public ToggleButton buildIconToggleButton(Object nodeId,
            ...
            boolean enabled) {
        // NOW MAKE THE TOGGLE BUTTON
        ToggleButton button = buildTextToggleButton(nodeId, parent, col, row, colSpan, rowSpan, styleClass, tg, enabled);
    ...
    public ToggleButton buildTextToggleButton(Object nodeId,
            ...
            boolean selected) {
        // NOW MAKE THE TOGGLE BUTTON
        ToggleButton button = initToggleButton(tg, selected);
    ...
    public ToggleButton buildTextToggleButton(Object nodeId,
            ...
            boolean enabled) {
        // NOW MAKE THE TOGGLE BUTTON
        ToggleButton button = initToggleButton(tg, enabled);
    ...
    private ToggleButton initToggleButton(ToggleGroup tg, boolean selected) {
    ...
    public Tab buildTab(Object nodeId,
        ...
        // MAKE AN INIT THE LABEL
        Tab tabToBuild = new Tab();

        // ADD TO THE PARENT PANE
        parentPane.getTabs().add(tabToBuild);
        
        // SET STYLE
        tabToBuild.getStyleClass().add(styleClass);
        
        // SET LABEL, MAKE SURE IT IS LANGUAGE DEPENDENT
        languageSettings.addLabeledControlProperty(nodeId.toString() + "_TEXT", tabToBuild.textProperty());
        
        if(selected){
            parentPane.getSelectionModel().select(tabToBuild);
        }
        
        // MAKE IT UNABLE TO CLOSE
        tabToBuild.setClosable(false);
